...
#Preview {
    ProductDetailsView(product: ProductModel(
        ...
        tags: nil,
        status: nil,
        variants: [Variant(id: 1, productId: 12121, title: nil, price: "99.99", sku: nil, position: nil, inventoryItemId: nil, inventoryQuantity: nil, oldInventoryQuantity: nil, imageId: nil)],
        options: nil,
        images: nil,
        image: nil
    ))
